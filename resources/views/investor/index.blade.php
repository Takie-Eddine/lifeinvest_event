           ...
           <div class="hamburger clearfix"><a href="javascript:void(0)"><span></span></a></div>
            <nav>
                <ul class="navigation clearfix">
                    <li class="active"><a href="javascript:void(0)">{{__('investor.home')}}</a></li>

                    <li><a href="javascript:void(0)">{{__('investor.about')}}</a></li>
                    <li><a href="javascript:void(0)">{{__('investor.service')}}</a></li>
                </ul>
            </nav>
        </div>
                    ...
                    <div class="dis-table">
                        <div class="dis-table-cell">
                            ...
                            <div class="table-content contact">
                                ...
                                @include('investor.alerts.errors')
                                @include('investor.alerts.success')
                                <form  action="{{route('investor.create')}}" method="post"  class="form clearfix animatt-middium">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-6 pl-0">
                                        <input name="first_name" id="name" type="text" placeholder="{{__('investor.first name')}}" class="form-control" value="{{old('first_name')}}" required>
                                        @error('first_name')
                                            <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-6 pl-0">
                                        <input name="last_name" id="name" type="text" placeholder="{{__('investor.last name')}}" class="form-control" value="{{old('last_name')}}" required>
                                        @error('last_name')
                                            <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-6 pl-0">
                                        <input name="city" id="name" type="text" placeholder="{{__('investor.city')}}" class="form-control" value="{{old('city')}}" required>
                                        @error('city')
                                            <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="dis-table-cell">
                            ...
                            <div class="table-content">
                                <div class="head animatt-fast">
                                    ...
                                    <h2 class="title">{{__('investor.about')}}<span>{{__('investor.text3')}}</span></h2>
                                </div>
                                <p class="animatt-middium">{{__('investor.text4')}}</p>
                        ...
                        <div class="dis-table-cell">
                            ...
                            <div class="table-content">
                                <div class="head animatt-fast">
                                    ...
                                    <h2 class="title">{{__('investor.service')}}<span>{{__('investor.text5')}}</span></h2>
                                </div>
                                <p class="animatt-middium">{{__('investor.text6')}}</p>
                                <div class="clearfix animatt-fast">
                                    <div class="col-lg-8 col-md-8 col-sm-8 nopadding service">
                                        <div class="service-head clearfix">
                                            <h4 class="service-title">{{__('investor.text7')}}</h4>
                                        </div>
                                        <p>{{__('investor.text8')}}</p>
                                    </div>
                                </div>
                                <div class="clearfix animatt-middium">
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 nopadding service">
                                        <div class="service-head clearfix">
                                            <h4 class="service-title">{{__('investor.text9')}}</h4>
                                        </div>
                                        <p>{{__('investor.text10')}}</p>
                                    </div>
                                </div>
                                <div class="clearfix animatt-slow">
                                    <div class="col-lg-8 col-md-8 col-sm-8 nopadding service">
                                        <div class="service-head clearfix">
                                            <h4 class="service-title">{{__('investor.text11')}}</h4>
                                        </div>
                                        <p>{{__('investor.text12')}}</p>
                                    </div>
                                </div>
                                <div class="clearfix animatt-fast">
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 nopadding service">
                                        <div class="service-head clearfix">
                                            <h4 class="service-title">{{__('investor.text13')}}</h4>
                                        </div>
                                        <p>{{__('investor.text14')}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
